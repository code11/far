define('app',['exports', 'aurelia-dependency-injection', 'aurelia-validation', 'resources/validation-renderer'], function (exports, _aureliaDependencyInjection, _aureliaValidation, _validationRenderer) {
  ...
  var App = exports.App = (_dec = (0, _aureliaDependencyInjection.inject)(_aureliaDependencyInjection.NewInstance.of(_aureliaValidation.ValidationController)), _dec(_class = function App(validationController) {
